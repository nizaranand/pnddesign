	...
	<?php if ( have_posts() ) : ?>
		...
		<div class="row">
			...
			<div class="searchcriteria">
				...
				<?php printf( __( 'Author Archives: %s', 'frogblog' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?>
				...
				<?php if(of_get_option('ft_blog_default') == 'excerpt'): ?>
					...
					<div class="post single">
						...
						<div class="post-details row">
							...
							<div class="post-details-info">par <?php the_author_posts_link(); ?>, <?php the_date('F jS, Y'); ?> | <?php echo get_the_category_list(', '); ?> | <a href="<?php comments_link(); ?>"><?php comments_number('0 Comments', '1 Comment', '% Comments'); ?></a></div>
