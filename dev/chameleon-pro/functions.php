...
function mysitemyway_button_shortcodes_stylesheet() {
    ...
    wp_enqueue_style( 'button-shortcode-styles', $template_dir . '/assets/css/shortcodes.css' );
}
...
function mysitemyway_button_shortcodes_js() {
	$template_dir = get_bloginfo('template_directory');
	wp_enqueue_script('button-shortcode-fade', $template_dir . '/assets/js/shortcodes.js', array('jquery'));
}
