...
if ( typeof window['vc_carouselBehaviour'] !== 'function' ) {
	function vc_carouselBehaviour() {
		...
		jQuery('.wpb_thumbnails-fluid .post-thumb img').removeAttr('width');
		jQuery('.wpb_thumbnails-fluid .post-thumb img').removeAttr('height');
		...
		jQuery(".wpb_carousel").each(function() {
		    ...
		    .width(carousel_width);//carousel_width
