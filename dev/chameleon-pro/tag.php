...
<div class="col-0-1-2-3" id="content">
	...
	<div class="row">
		<div class="searchcriteria">
			<?php printf( __( 'Tag Archives: %s', 'frogblog' ), '<span>' . single_tag_title( '', false ) . '</span>' ); ?>
					...
					<div class="post single">
						...
						<div class="post-excerpt">
							...
							if(has_post_thumbnail()): 
								...
								?>
								<img src="<?php echo $image_url[0]; ?>" alt="" class="aligncenter size-full" />
							...
							<?php endif; ?>
							<?php endif; ?></a></p>
							<?php echo frog_the_excerpt_reloaded(120, '<a>,<p>,<img>,<h1>,<h2>,<h3>,<h4>', 'content', FALSE, '...', FALSE, 1); ?>
